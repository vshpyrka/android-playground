...
dependencyResolutionManagement {
    ...
    versionCatalogs {
        create("pluginLibs") {
            from("com.vshpyrka.android:version-catalog-plugins:0.10.41")
        }
        create("libs") {
            from("com.vshpyrka.android:version-catalog-libs:0.10.41")
        }
        create("testLibs") {
            from("com.vshpyrka.android:version-catalog-test:0.10.41")
        }
        create("sdk") {
            from("com.vshpyrka.android:version-catalog-sdk:0.10.41")
        }
    }
}
